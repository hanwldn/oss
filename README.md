...
> **서버 상태를 모니터링 및 점검**해야 하는 경우 사용하는 명령어로 

> **동작중인 프로세스의 상태, CPU, 메모리, 시스템부하**를 실시간으로 화면에 출력해 줍니다.
...
> **현재 수행되고(실행되고) 있는 프로세스에 관한 정보 상태**를 화면에 출력하는 명령어
